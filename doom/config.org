...
- Completion ::
- use [[kbd:TAB][TAB]]
- confirm the autocompletion with [[kbd:RET][RET]]  (consistent with all other programs on the os (neovim, nushell, browser...))
- formatting :: configure language formatters externally (config-file) to use 8 spaces indentation.
