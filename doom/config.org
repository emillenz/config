...
- Automatically prompt me for buffer/dir to open after splitting/newtab. (using buffer/recentfile fzf)
- I always do this so automate it (DRY)
#+begin_src emacs-lisp
...
** Snippet helper
- This is used in the custom yasnippet: ~src_block~ => inserts src block with the language prefilled.
#+begin_src emacs-lisp
