...
- i prefix ~z~ in user defined functions and variables to distinguish them clearly from package related ones.
...
- i encourage you to master the tool that you are using.  this means thuroughly reading the complete documentation, keybinding cheatsheets for the tools you are using (eg. vertico, evil-mode).
