...
- buffers ::
  - use [[kbd:C-l][C-l]] to alternate between the [L]ast buffer and current buffer.  for all other buffer navigation needs use: [[kbd:C-g][C-g]] for pulling up an arbitrary buffer.
