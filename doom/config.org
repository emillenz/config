...
** tabs
- only open tabs whe you know you need to hotswitch between the individual files.  in all other cases just use buffer searching (faster, less time spent on managing the tabs)
#+begin_src emacs-lisp
(tab-bar-mode 1)
...
- daily journal ::
  ...
  - end of day ::
    - reflect :: on the goals and check off what you achived and what not.  if not, why, and what needs to happen for it to get done next time?
    - gratitude :: list things that you were grateful for / appreciate and relive nice experiences/moments you want to remember and cherish.
