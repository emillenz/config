...
(yas-define-snippets '+javascript-gulp-mode
                     '(("ts-angular"
                        ...
                        "/home/lenz/.config/doom/snippets/+javascript-gulp-mode/ts-angular" nil nil)
                       ("ts"
                        "const util       = require(\"gulp-util\"),\n      browserify = require(\"browserify\"),\n      source     = require(\"vinyl-source-stream\"),\n      buffer     = require(\"vinyl-buffer\"),\n      uglify     = require(\"gulp-uglify\");\n\ngulp.task(\"ts\", () => {\n    return browserify({ entries: ${1:dir.source} + \"app.ts\", debug: true })\n        .plugin(tsify)\n        .bundle().on(\"error\", err => { console.error(err.toString()); })\n        .pipe(source(\"app.js\"))\n        .pipe(buffer())\n        .pipe(util.env.pack ? uglify() : util.noop())\n        .pipe(gulp.dest(${2:dir.build} + \"/app/\"));\n});"
                        "Typescript compilation task" nil nil nil
                        "/home/lenz/.config/doom/snippets/+javascript-gulp-mode/ts" nil nil)
                       ("task" "gulp.task('${1:task-name}', ($2) => {\n    `%`$0\n});" "Gulp task"
                        nil nil nil "/home/lenz/.config/doom/snippets/+javascript-gulp-mode/task"
                        nil nil)
                       ("tape"
                        "const tape   = require(\"gulp-tape\"),\n      faucet = require(\"faucet\");\n\ngulp.task(\"test\", () => {\n    return gulp.src(\"test/**/test_*.js\")\n        .pipe(tape({reporter: faucet()}))\n});"
                        "Tape test-runner task" nil nil nil
                        "/home/lenz/.config/doom/snippets/+javascript-gulp-mode/tape" nil nil)
                       ("sass"
                        ...
                        "/home/lenz/.config/doom/snippets/+javascript-gulp-mode/sass" nil nil)
                       ("pug"
                        ...
                        "/home/lenz/.config/doom/snippets/+javascript-gulp-mode/pug" nil nil)
                       ("es6"
                        ...
                        "/home/lenz/.config/doom/snippets/+javascript-gulp-mode/es6" nil nil)
                       ("default" "gulp.task('default', $0);" "Default gulp task" nil nil nil
                        "/home/lenz/.config/doom/snippets/+javascript-gulp-mode/default" nil nil)
                       ("browsersync"
                        ...
                        "/home/lenz/.config/doom/snippets/+javascript-gulp-mode/browsersync" nil nil)))
