...
(yas-define-snippets 'org-mode
                     '(("width" "#+attr_html: :width ${1:500px}" "#+attr_html: :width ..." nil nil nil "/home/lenz/.config/doom/snippets/org-mode/width" nil nil)
                       ...
                       ("trigger-key" "" "" t nil nil "/home/lenz/.config/doom/snippets/org-mode/src-" nil nil)
                       ("src" "#+begin_src $1\n`%`$0\n#+end_src" "#+begin_src" nil nil nil "/home/lenz/.config/doom/snippets/org-mode/src" nil "src")
                       ...
                       ("head" "#+title:    `(capitalize (replace-regexp-in-string \"[-_.]\" \" \" (file-name-sans-extension (file-name-nondirectory (buffer-file-name (current-buffer))))))`\n#+author:   `user-full-name`\n#+email:    `user-mail-address`\n#+date:     `(format-time-string \"%A, %e %B, %Y\")`\n#+info:     ${0:Short description of document.}\n\n$1\n" "org-file header" nil nil nil "/home/lenz/.config/doom/snippets/org-mode/header" nil "head")
