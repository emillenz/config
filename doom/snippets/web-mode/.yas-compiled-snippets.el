...
(yas-define-snippets 'web-mode
                     '(("vue"
                        ...
                        (equal web-mode-engine "vue") nil nil
                        "/home/lenz/.config/doom/snippets/web-mode/vue" nil
                        "vue")
                       ("video"
                        ...
                        "/home/lenz/.config/doom/snippets/web-mode/video" nil
                        nil)
                       ("php" "<?php `(doom-snippets-format \"%n%s%n\")`$0 ?>"
                        "<?php ... ?>" nil nil nil
                        "/home/lenz/.config/doom/snippets/web-mode/php" nil nil)))
