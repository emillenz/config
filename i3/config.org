...
set $sys_sleep i3lock --color 000000 && systemctl suspend
...
client.focused_inactive $modeline $modeline $fg   $bg        $modeline
client.unfocused        $bg       $bg       $fg   $bg        $bg
client.urgent           $accent   $accent   $fg   $bg        $bg
client.placeholder      $modeline $modeline $fg   $bg        $bg
