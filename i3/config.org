...
$map XF86Sleep             $cmd i3lock -e --color FBF7EF && systemctl suspend
...
mode "$powermenu" {
  ...
  $map $mod+l       $cmd i3lock -e --color FBF7EF && systemctl suspend; $esc
...
client.focused_inactive $foreg  $foreg  $backg  $backg    $backg
