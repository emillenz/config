...
for_window [all] title_window_icon yes, output primary
...
assign [class="cmd"]     $ws_cmd
assign [class="Zathura"] $ws_doc
assign [class="firefox"] $ws_web
assign [class="emacs|eclipse"]   $ws_edit

assign [class="ncmpcpp"] $ws_music
assign [class="mpv"]     $ws_video
assign [class="nsxiv"]   $ws_images
...
bindsym $mod+shift+c move container to workspace $ws_cmd;    workspace $ws_cmd
bindsym $mod+d workspace $ws_doc
bindsym $mod+shift+d move container to workspace $ws_doc;    workspace $ws_doc
bindsym $mod+w workspace $ws_web
bindsym $mod+shift+w move container to workspace $ws_web;    workspace $ws_web
bindsym $mod+e workspace $ws_edit
bindsym $mod+shift+e move container to workspace $ws_edit;   workspace $ws_edit
...
bindsym $mod+shift+i move container to workspace $ws_images; workspace $ws_images
bindsym $mod+a workspace $ws_all
bindsym $mod+shift+a move container to workspace $ws_all;    workspace $ws_all
#+end_src
