...
- Alias returning to default mode (shorter)
#+begin_src conf
...
mode "$leader" {
  ...
  bindsym $mod+s exec ~/.config/bin/startup; $esc
  bindsym Escape $esc
}
#+end_src
...
mode "$menus" {
  bindsym $mod+a       exec ~/.config/bin/audio-menu;       $esc
  bindsym $mod+o       exec ~/.config/bin/output-menu;      $esc
  bindsym $mod+shift+o exec ~/.config/bin/layout-menu;      $esc
  bindsym $mod+s       exec ~/.config/bin/screenshot-menu;  $esc
  bindsym $mod+b       exec ~/.config/bin/bluetooth-menu;   $esc
  bindsym $mod+p       exec ~/.config/bin/killprocess-menu; $esc
  bindsym Escape $esc
}
#+end_src
