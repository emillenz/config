...
for_window [class="(?i)emacs|(?i)eclipse"] move container to workspace $ws_edit

for_window [class="(?i)mpv"] move container to workspace $ws_video
for_window [class="(?i)nsxiv"] move container to workspace $ws_image
...
bindsym $mod+shift+i move container to workspace $ws_image
