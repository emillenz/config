...
mode "open" {
  ...
  $map $mod+e       $cmd emacsclient --reuse-frame || emacs --bg-daemon --eval='(doom/reload)' ; $esc
...
client.focused          $main  $main $bg  $fg       $main
...
set $fg         #ffffff
set $focus      #2266ae
set $focus_alt  #535353
set $urgent     #ff5f59

# class                 $border    $bg        $text $indicator $child_border
client.focused          $focus     $focus     $fg   $fg        $focus
client.focused_inactive $focus_alt $focus_alt $fg   $bg        $bg
