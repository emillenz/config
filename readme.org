...
* keybindings
** general notes
- [[kbd:ctrl/esc][ctrl/esc]] :: mapped to [[kbd:caps][caps]] this greatly increases ergonomics and speed for all ctrl-bindings and goes hand in hand with [[kbd:c-w/h][c-w/h]] for deleting words and characters in the shell.
