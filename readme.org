...
* Font: Iosevka Comyf (Custom iosevka build)
...
- It was specifically designed for long terminal / editor sessions (8+ hours). it aims to reduce eye strain and help readability in the long term. (Try using terminus with a ligth theme in a dark room for 8h)
...
- It is a minimal, thin, sharp and fast. This allows it to be used in all context and interfaces.
...
- For full immersion and focus disable it and work fullscreen.
  + No overlapping functionality: you are wearing a watch -> don't need time & date.
  + You always know what window you are looking at by its contents.
  + You don't need visual indication of how to navigate to tabs, nor interact with the statusbar (ex: click something) => keyboard only workflow.

*** Completion menu: Rofi
- It's configured to look and Function consistent with emacs and the terminals completion frameworks. (fzf)
- Purely text-based
