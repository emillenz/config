...
- UI: Think of the ui as a  hud
  ...
  + Window/tabbars at the top, statusbars generally on the bottom.
...
- Using thin/lightweight/sharp over thick/heavy/rounded (box drawings / terminal characters / symbols)
