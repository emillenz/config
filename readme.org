...
* font: comic code
- has incredibly good legibility due to the slightly irregular, but distinctly slanted characters. (most importantly at small sizes.) and is just easy to read overall.
- it works well anywhere. /s
- it is an unapologetic admittance of comic sans’s positives and a literal manifestation of “code like nobody’s watching”.
- the fundamental concept: sometimes, professional appearance is exactly what you don’t want. make code less intimidating to humans and thus easier to comprehend.
- it is designed by typographer toshi omagari.

** comic code is the toyota corolla of cars
- you can put comic code in every color, ever background, and it looks good.
- imagine using this font in business emails, contracts, death certificates eviction notices, bank statements and university lectures, thesises or mathematical proofs. its ugly, its childish and juvenile, it looks like a worn out couch with beer stains on it in a trailer park. and this ridiculousness is exactly why i fucking love it. it does things differently and makes people smile because of the absurdity.
- comic code is the crocs of fonts. it is ugly, it is childish, it is often colourful, it looks soft and curved and strange. it is the antithesis to all of the lovely liquid fonts out there, a wonky alternative to the minimal clean helvetica of the world. it is also a breath of childhood innocence against the seriousness of serif-based fonts like times new roman or georgia.
