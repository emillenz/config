...
- in the wm, the set of program-names during runtime is known and consistent (unlike the set of buffers in applications, where tab-names are either unnamed, arbitrary or change during runtime), we use specific-chars for switching to the tabs
...
|---------+--------------------------------+---------------------|
| [[kbd:g][g]]       | goto buffer  (find)            | vim: goto           |
| [[kbd:q][q]]       | quit (buffer)                  | mnemonic / standard |
| [[kbd:e][e]]       | edit file / editor (from path) | mnemonic, vim ~:e~    |
| [[kbd:f][f]]       | find (program/file, fuzzy)     | mnemonic / standard |
| [[kbd:r][r]]       | recent (file, fuzzy)           | mnemonic / standard |
| [[kbd:x][x]]       | run-command (internal)         | emacs               |
| [[kbd:l][l]]       | last/alternate-buffer          | mnemonic, ergo      |
