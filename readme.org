...
** general notes
- super / alt :: remapped [[kbd:super][super]] to [[kbd:alt_l][alt_l]] opposite to [[kbd:alt_r][alt_r]] key for ergonomics (alternative is to just use alt as the wm-modkey, however sometimes alt is needed, so this is not a good solution.)
...
- applications :: [[kbd:ctrl][ctrl]] since that is the defacto standard, aligns with vim's navigational-ctrl-layer-keybind (and is now ergonomically bound).
...
| [[kbd:l][l]]       | [l]ocation (open file/url)   | mnemonic / standard |
...
| [[kbd:b][b]]       | [b]ack to last [b]uffer      | mnemonic, ergo      |
| [[kbd:j][j]]       | completion-menu next         | vim                 |
| [[kbd:k][k]]       | completion-menu previous     | vim                 |
| [[kbd:tab][tab]]     | complete                     | emacs            |
| [[kbd:spc][spc]]     | leader-key                   | vim / ergonomic     |

** forget symbol layers and homerow mods
