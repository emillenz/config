...
- For full immersion, reduced distraction and enhanced focus, disable it and work fullscreen.
  + No overlapping functionality. Ex:: you are wearing a watch -> don't need time & date displayed.
...
- The aestetic and efficiency of a decluttered and maximized screen is opinionated) unmatched.

** Completion menu: Rofi
- It's configured to look and Function consistent with emacs and the terminal's completion frameworks. (fzf)
- Purely text-based
