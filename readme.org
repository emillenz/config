...
- abstain from using [[kbd:alt-tab][alt-tab]] (switching back to recent tab)
...
|---------+-----------------------------+---------------------|
| [[kbd:k/j][k/j]]     | prev/next window (!not tab) | vim, ergonomics     |
| [[kbd:1-4][1-4]]     | switch to tab by index      | logic / stardard    |
| [[kbd:g][g]]       | goto tab/buffer  (find)     | vim: goto           |
| [[kbd:q][q]]       | quit (buffer/program)       | mnemonic / standard |
| [[kbd:e][e]]       | edit file / editor          | mnemonic, vim ~:e~    |
| [[kbd:f][f]]       | find (program/file)         | mnemonic / standard |
| [[kbd:x][x]]       | run-command (program)       | emacs               |
| [[kbd:c][c]]       | command-line (shell)        | standard            |
| [[kbd:w][w]]       | web (browser)               | mnemonic, www       |
| [[kbd:o][o]]       | open (file/program)         | mnemonic / standard |
...
- these main apps have a dedicated open shortcut, all other apps are better to be opened via ~M-x~
