...
** general notes
- esc :: remapped to the most optimal (ergonomical) key [[kbd:capslock][capslock]]
- [[kbd:ctrl][ctrl]] :: mapped to [[kbd:alt_r][alt_r]], since [[kbd:alt][alt]] is the wm-modkey.  using the thumbs for the modifiers is fast and ergonomic since all fingers have full range of motion and the thumb is the strongest finger.  inspired by the reasearchers that fabricate ergonomic keyboards with a thumb cluster such as: kinesis advatage.
