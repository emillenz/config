...
- It was specifically designed for long terminal / editor sessions (8+ hours). it aims to reduce eye strain and help readability in the long term. (Try using terminus with a ligth theme in a dark room for 8h and observe what kind of strain it wil put on you.)
...
** Notes
Try a light theme with a bitmap font like Terminus for 8 hours. It will be a tormenting experience! To maximamise the difficulty, do it in a dark room with the monitor’s brightness set to its maximum value.
* Dependencies
