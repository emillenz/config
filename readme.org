...
| [[kbd:l][l]]       | [l]last buffer/tab (a[l]ternate) |
| [[kbd:;][;]]       | run-cmd                          |
| [[kbd:j][j]]       | up completion menu               |
| [[kbd:k][k]]       | down completion menu             |
| [[kbd:1-4][1-4]]     | focus buffer/tab 1-4             |
| [[kbd:tab][tab]]     | completion                       |
...
1. [l]ast tab :: when you are alternating between 2 files/tabs or need to just jump back to the last visited buffer.  this takes the least amount of overhead and is the fastest.
